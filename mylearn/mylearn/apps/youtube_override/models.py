...
class VideoTopicourse(models.Model):
    ...
    def save(self, *args, **kwargs):
        ...
        if not self.id:
            ...
            # Save the instance
            super(VideoTopicourse, self).save(*args, **kwargs)
        ...
        # Save the model
        return super(VideoTopicourse, self).save(*args, **kwargs)
    ...
    def delete(self, *args, **kwargs):
        ...
        return super(VideoTopicourse, self).delete(*args, **kwargs)
...
class Thumbnail(models.Model):
    video = models.ForeignKey(VideoTopicourse, null=True)
