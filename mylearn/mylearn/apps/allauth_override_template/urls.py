...
urlpatterns = patterns(PROJECT_APP_PREFIX + '.allauth_override_template.views',
    ...
    url(r"^accounts/password/change/$", 'password_change_learn', name="account_change_password_learn"),
    url(r'^accounts/password/reset/$', 'password_reset_learn', name="account_reset_password_learn"),
